                ...
                <div class="mt-2">
                    ...
                    <div class="container" style="display: flex; justify-content: center; border: 1px solid black; width: 300px; border-radius: 30px">
                        ...
                        <form action="" method="POST" class="mt-3 mb-3">
                            <label for="#namak">Nama Kategori</label>
                            <input type="text" name="namakategori" placeholder="Nama Kategori Baru" class="form-control" id="namak"> <br>
                    ...
                    if(isset($_POST["submit"])){
                        $namak = $_POST["namakategori"];
                        $sqluser = mysqli_query($conn, "SELECT nama FROM kategori WHERE nama='$namak'");
                                ...
                                <?php 
                                    ...
                                    while ($row = $result->fetch_assoc()) 
                                    {
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="idmodal" class="form-control" value="<?php echo $row['id']; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleFormControlInput1">Jenis Kategori</label>
                                                                <input type="text" name="namamodal" class="form-control" value="<?php echo $row['nama']; ?>">
                                                            </div>
                                                            <?php 
                                                                echo '<button type="submit" name="buttonedit" class="btn btn-primary">Save changes</button>';
                                                                    if(isset($_POST['buttonedit'])){
                                                                    $namamodal = $_POST['namamodal'];
                                                                    $idmodal = $_POST['idmodal'];

                                                                    $update = mysqli_query($conn, "UPDATE Kategori SET nama='$namamodal' WHERE id='$idmodal'");
                                                                    ?>
                                        ...
                                        <form action="" method="POST">
                                            <button type="submit" class="btn btn-danger" name="buttonhapus" value="<?php echo $row['id']; ?>">Hapus</button>
                                            <?php 
                                                if(isset($_POST['buttonhapus'])){
                                                    ...
                                                    if($dataCount>0){
                                                        ?>
                                                        <div class="alert alert-warning mt-3" role="alert" style="display: flex; float:right">
