    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="mt-2">
                    <h3 style="text-align:center">Tambah Slide</h3>
                    <div class="container" style="display: flex; justify-content: center; border: 1px solid black; width: 300px; border-radius: 30px">
                        <form action="" method="POST" enctype="multipart/form-data" id="my-form" class="mt-3 mb-4">
                            <label for="#foto">Slide Image</label>
                    ...
                    if(isset($_POST["simpan"]))
                    {
                        ...
                        move_uploaded_file($fotod_tmp, '../fotoslide/'.$fotod);

                            $sql = mysqli_query($conn, "INSERT INTO Slide_Show (namaSlide) 
                            VALUES ('$fotod')");
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead class="table-dark">
                                ...
                                <th style="text-align: center">Foto Slide</th>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    {
                                        echo '<tr>';
                                        echo '<br><td style="text-align: center">'.$row['idSlide'].'</td>';
                                        echo "<td><center><img src='../fotoslide/$row[namaSlide]' height=75 width=100></center></td>";
                                        echo '<td>'; ?> 
                                        
                                        <a href="" class="btn btn-sm btn-info" data-toggle="modal"
                                            data-target="#modal<?php echo $row['idSlide']; ?>">Edit</a>
                                        <div class="modal fade" id="modal<?php echo $row['idSlide']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <label for="exampleFormControlInput1">Id Slide</label>
                                                                <input type="text" class="form-control" value="<?php echo $row['idSlide']; ?>" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="foto-slide" style="text-align: center">
                                                                    <p style="font-weight: bold; color: black">Foto Slide Sekarang</p>
                                                                    <?php 
                                                                    echo "<img src='../fotoslide/$row[namaSlide]' height=100 width=200>";
                                                                    ?> 
                                                                </div>  
                                                            ...
                                                            <button type="submit" name="buttonedit" class="btn btn-primary" value="<?php echo $row['idSlide']; ?>">Save changes</button>
                                                            <?php 
                                                                    ...
                                                                    if(isset($_POST['buttonedit'])){
                                                                        ...
                                                                        {
                                                                            $fotoproduk = $row['namaSlide'];
                                                                            $fotoproduk_tmp = $_FILES['fotop']['tmp_name'];
                                                                            move_uploaded_file($fotoproduk, '../fotoslide/'.$fotoproduk);
                                                                        }else{
                                                                            $fotoproduk = $_FILES['fotop']['name'];
                                                                            $fotoproduk_tmp = $_FILES['fotop']['tmp_name'];
                                                                            move_uploaded_file($fotoproduk_tmp, '../fotoslide/'.$fotoproduk);
                                                                        }

                                                                        $updateTabel = mysqli_query($conn, "UPDATE slide_show SET namaSlide='$fotoproduk' WHERE idSlide='$idp'");
                                                                    ?>
                                                                        <meta http-equiv="refresh" content="0; url=slide.php"/>
                                                                    <?php
                                                                } 
                                                            ?>
                                                        </form>
                                        ...
                                        <form action="" method="POST">
                                            <button type="submit" name="buttonhapus" class="btn btn-danger" value="<?php echo $row['idSlide']; ?>">Hapus</button>
                                            <?php 
                                                if(isset($_POST['buttonhapus'])){
                                                    $id = $_POST['buttonhapus'];
                                                    $queryhapus = mysqli_query($conn, "DELETE FROM Slide_Show WHERE idSlide='$id'");
                                                    ?>
                                                    <meta http-equiv="refresh" content="0; url=slide.php"/>
                                                    <?php
                                                }
