...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Produk</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlahProduk ?> Produk</div>
                                    </div>
                                    <div class="col-auto">
            ...
            <!-- Footer -->
            <div class="container" style=" position: fixed;height: 70px;bottom: 0px; margin-bottom: 0px;">
